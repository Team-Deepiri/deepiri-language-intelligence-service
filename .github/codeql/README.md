# CodeQL Setup for deepiri-language-intelligence-service
...
### `paths`
The current include list is intentionally scoped to maintained service runtime and migration code:
